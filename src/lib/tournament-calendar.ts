...
const rapsodoFriendlyCourseNames = new Set([
...
export const dailyTournamentCourses: ScheduledCourse[] = popularDailyCourses.filter((course) =>
  rapsodoFriendlyCourseNames.has(course.name),
);

export const dailyTournamentCourseCount = dailyTournamentCourses.length;
