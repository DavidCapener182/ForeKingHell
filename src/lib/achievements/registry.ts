...
export const CORE_ACHIEVEMENTS: Achievement[] = (
  [
    ...
    achievement(
      "first_speed_session",
      "Speed Baseline",
      "Log your first Speed Centre session.",
      "speed",
      "bronze",
      "speedTraining",
      1,
    ...
    achievement(
      "speed_reps_100",
      "100 Speed Reps",
      "Log 100 total swings in Speed Centre.",
      "speed",
      "silver",
      "speedTraining",
      100,
    ...
    achievement(
      "speed_reps_250",
      "250 Speed Reps",
      "Log 250 total swings in Speed Centre.",
      "speed",
      "gold",
      "speedTraining",
      250,
    ...
    achievement(
      "speed_target_set",
      "Target Set",
      "Save a Speed Centre session with a target speed.",
      "speed",
      "bronze",
      "speedTraining",
      1,
    ...
    achievement(
      ...
      "Club Target Set",
      "Save a target speed against a club in your bag.",
      "speed",
      "bronze",
      "speedTraining",
      1,
    ...
    achievement(
      ...
      "Three Club Targets",
      "Set target speeds for 3 different clubs.",
      "speed",
      "silver",
      "speedTraining",
      3,
    ...
    achievement(
      ...
      "Five Club Targets",
      "Set target speeds for 5 different clubs.",
      "speed",
      "gold",
      "speedTraining",
      5,
    ...
    achievement(
      "speed_target_hit",
      "Speed Target Hit",
      "Average at or above a Speed Centre session target.",
      "speed",
      "silver",
      "speedTraining",
      1,
    ...
    achievement(
      ...
      "Driver Speed Target Hit",
      "Average at or above a driver speed-session target.",
      "speed",
      "gold",
      "speedTraining",
      1,
    ...
    achievement(
      ...
      "Three Club Targets Hit",
      "Hit target-speed averages for 3 different clubs.",
      "speed",
      "platinum",
      "speedTraining",
      3,
    ...
    achievement(
      "driver_training_speed_90",
      "Driver Speed 90",
      "Average 90+ mph in a driver Speed Centre session.",
      "speed",
      "silver",
      "speedTraining",
      90,
    ...
    achievement(
      "driver_training_speed_95",
      "Driver Speed 95",
      "Average 95+ mph in a driver Speed Centre session.",
      "speed",
      "gold",
      "speedTraining",
      95,
    ...
    achievement(
      "driver_training_speed_100",
      "Driver Speed 100",
      "Average 100+ mph in a driver Speed Centre session.",
      "speed",
      "diamond",
      "speedTraining",
      100,
