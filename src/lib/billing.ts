...
export const billingPlans: BillingPlan[] = [
  {
    ...
    description: "Core importing, basic analytics and friend social features.",
    features: ["Rapsodo CSV import", "Basic dashboard", "Friend feed", "Public profile", "Monthly public challenge"],
    priceEnv: {},
  },
  {
    key: "plus",
    ...
    description: "Advanced history, gapping, private challenges and share-card customisation.",
    features: ["Unlimited history", "Advanced bag gapping", "Private challenges", "Advanced leaderboards", "Export reports"],
    priceEnv: {
  ...
  },
  {
    ...
    description: "AI coaching, comparison insights, challenge analytics and advanced adapters.",
    features: ["AI coach", "Strokes-gained analysis", "Friend comparison insights", "Challenge analytics", "Square and TrackMan adapters"],
    priceEnv: {
  ...
  },
  {
    ...
    description: "Player groups, coach challenges, reports and seat-based access.",
    features: ["Coach dashboard", "Player groups", "Coach-created challenges", "Private leaderboards", "Progress reports"],
    priceEnv: {
  ...
  },
  {
    ...
    features: ["Unlimited imports", "AI coach", "Coach dashboard", "All provider adapters", "Admin operations"],
    priceEnv: {},
    internal: true,
  },
];
