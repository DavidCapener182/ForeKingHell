      ...
      <section className="mobile-progress-overview" aria-label="Progress overview">
        ...
        {summary.totals.trackedCleanShots ? (
          <>
            ...
            <MobileStatus label={`${story.confidence} · session comparison`} tone={story.tone} />
            <details>
              <summary className="mobile-progress-disclosure">What this score means</summary>
              <p className="mobile-type-footnote text-muted-foreground">
                The existing score combines club trust, playable shots, sample depth and baseline
                movement. Direction above compares the last two measured sessions for each club. A
                higher score alone does not prove improvement.
              </p>
              <p className="mobile-type-footnote text-muted-foreground">
                {summary.totals.trackedCleanShots} clean shots · {summary.totals.averageTrust}%
                average club trust.
              </p>
            </details>
          </>
      ...
      <MobileSection title="Scoring">
        ...
        {scoring.leak ? (
          <div className="grid gap-2">
            <p className="mobile-type-footnote text-muted-foreground">Main recorded scoring leak</p>
        ...
        {training.hasTrainingData ? (
          <>
            <div className="mobile-metric-strip">
              <MobileMetric value={Math.round(training.summary.fitness.value)} label="fitness" />
              <MobileMetric
