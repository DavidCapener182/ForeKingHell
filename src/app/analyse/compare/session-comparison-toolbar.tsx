...
export function SessionComparisonToolbar({
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-3 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto_auto] xl:items-end">
        <EntityCombobox
          label="Focus session"
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-3 border-t border-border/60 pt-3">
        ...
        <ButtonGroup aria-label="Comparison period">
          <Button
            type="submit"
            name="period"
            value="sessions"
            size="sm"
            variant={period === "sessions" ? "secondary" : "ghost"}
            className={cn(period === "sessions" && "text-foreground")}
            aria-pressed={period === "sessions"}
          >
            Sessions
          </Button>
          <Button
            ...
            className={cn(period === "month" && "text-foreground")}
