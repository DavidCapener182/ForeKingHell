...
import { saveBagOrderWithStateAction } from "@/app/equipment/actions";
import {
  BAG_SECTIONS,
  initializeBagOrder,
  moveBagClub,
...
export function BagOrderForm({ clubs }: { clubs: BagOrderClubItem[] }) {
  ...
  return (
    <div data-bag-order-form>
      <DraftForm
        action={saveBagOrderWithStateAction}
        submitLabel="Save bag order"
        onSuccess={() => router.refresh()}
        onCancel={() => setItems(initializeBagOrder(clubs))}
                    ...
                    >
                      <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-2">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-semibold tracking-normal">{club.label}</p>
