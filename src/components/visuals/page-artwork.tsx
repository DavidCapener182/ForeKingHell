...
const artworkByVariant: Record<PageArtworkVariant, string> = {
  ...
  range: "/assets/page-practice-grid.webp",
  ...
  leaderboard: "/assets/page-leaderboard-podium.webp",
  challenges: "/assets/challenge-longest-drive.webp",
  tournaments: "/assets/tour-covers/tour-cover-01.webp",
  friends: "/assets/page-friends-match.webp",
  groups: "/assets/page-groups-clubhouse.webp",
  settings: "/assets/page-settings-locker.webp",
...
const imageTreatmentByVariant: Partial<Record<PageArtworkVariant, string>> = {
  ...
  equipment: imageTreatmentByCrop.fairway,
  progress: imageTreatmentByCrop.fairway,
  rounds: imageTreatmentByCrop.fairway,
  stockYardages: imageTreatmentByCrop.fairway,
  speed: imageTreatmentByCrop.fairway,
  leaderboard: imageTreatmentByCrop.fairway,
  friends: imageTreatmentByCrop.fairway,
  groups: imageTreatmentByCrop.fairway,
  settings: imageTreatmentByCrop.fairway,
