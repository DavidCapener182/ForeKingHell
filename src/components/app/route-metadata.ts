...
const baseAppRouteMetadata = [
  ...
  meta(
    ...
    "bag",
    Radar,
    ["calibration", "launch monitor", "trackman", "rapsodo", "data confidence"],
    { mobileMoreGroup: "Account", desktopVisible: false },
  ),
  meta(
    "rapsodo",
    "/rapsodo",
...
export function mobileBackNavigation(pathname: string): MobileBackNavigation | null {
  const exactParents: Record<string, MobileBackNavigation> = {
    ...
    "/equipment/launch-monitors/calibration": { href: "/equipment", label: "Equipment" },
