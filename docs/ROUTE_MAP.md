...
| Feature            | Routes                                                                                                                                                | Where users find it                                                           |
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Courses            | `/courses`, `/courses/new`, `/courses/strategy`, `/courses/[courseId]/holes`, `/courses/[courseId]/shot-pattern`, `/course-twins`, `/play/[courseId]` | Play navigation, first-class Course Twin catalogue and pre-round preparation. |
