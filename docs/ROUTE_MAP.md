...
| Companion routing        | `/companion/handoff`, `/companion/summary`, `/companion-runtime/import`, `/companion-runtime/import/result`, `/companion-runtime/rapsodo` | Early desktop-only handoff, compact summaries and internal surface-specific bundle rewrites. |
