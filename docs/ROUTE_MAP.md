...
| Companion routing        | `/companion/handoff`, `/companion/summary`, `/companion-runtime/import`, `/companion-runtime/import/csv`, `/companion-runtime/import/result`, `/companion-runtime/rapsodo`, `/companion-runtime/today` | Early desktop-only handoff, compact summaries and internal surface-specific bundle rewrites. |
